package onlineshopping;
	...
	//created another class name as RetailStore
	public class RetailStore {
	   ...
	   public int checkProductAvailability(String ProductName){
		...
		/*this methodThe method takes a customer ID and discount percentage as
          input parameters and calculates and returns the net amount that the
          customer need to pay for the entire booking he has made. Net amount=
